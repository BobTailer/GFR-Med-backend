...
func (r *Repository) GetGlomerularCalculationsList(status *string, formedFrom *time.Time, formedTo *time.Time, creatorID *uint) ([]models.GlomerularCalculation, error) {
